  ...
  return (
    <animated.div className="settings-panel" style={springs}>
      ...
      <div className="profile-viewer__user-info">
        ...
        />
        <InfoRow
          rowName="Актуальний пароль"
          rowValue={currentPassword}
          setValue={setCurrentPassword}
          type="password"
          invalid={updateErrors.errorTypes.some((t) => t === "currentPassword")}
        />
        <InfoRow
          rowName="Новий пароль"
          rowValue={newPassword}
          setValue={setNewPassword}
          type="password"
          invalid={updateErrors.errorTypes.some((t) => t === "newPassword")}
        />
